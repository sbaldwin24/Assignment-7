...
var averagePrice = items.map(function(item) {
return item.price;
})
.reduce(function(x,y) {
return x + y;
...
var price14_18_Array = items.filter(function(item) {
...
var lostRevWar = items.filter(function(item) {
...
items.filter(function(item) {
  return item.materials.length >= 8;
    ...
    item2.materials.forEach(function(x) {
      console.log(x);
    });
});
